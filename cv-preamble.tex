...
% Define left column to be only 6em small
...
\newcommand{\cvspace}{\vspace*{0.5em}}
...
\newcommand{\iconBirthday}{\makebox[1.5em][c]{\small\faIcon{birthday-cake}}}
\newcommand{\iconAddress}{\makebox[1.5em][c]{\small\faIcon{map-marked-alt}}}
