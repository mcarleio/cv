...
\cvitem{}{
    Ich modernisiere die bestehende verteilte Softwarelandschaft durch den Einsatz von hexagonalen
    Architekturen und Spring Boot und optimiere die bestehenden Prozessabläufe mit Camunda.
}
\cvspace
...
\cvdoubleitem{> 10 Jahre}{Java, JavaScript, HTML, Bash, SQL}{> 10 Jahre\cbstart}{Linux, Windows}
\cvdoubleitem{> 2 Jahre}{Kotlin, TypeScript}{> 2 Jahre\cbend}{AWS, Android}
\cvspace

\cvdoubleitem{}{\strut\subsectionstyle{Backend Frameworks}}{}{\strut\subsectionstyle{Datenbanken}}
\cvdoubleitem{> 10 Jahre}{Hibernate}{> 9 Jahre\cbstart}{Oracle}
\cvdoubleitem{> 6 Jahre}{Java EE}{> 5 Jahre}{MySQL, MariaDB, H2}
\cvdoubleitem{> 2 Jahre}{Spring Boot, Camunda}{> 3 Jahre}{PostgreSQL, Derby}
\cvdoubleitem{> 1 Jahr}{Quarkus, OSGi, NodeJS}{> 1 Jahr\cbend}{NoSQL (Neo4j, MongoDB, Redis)}
\cvspace

\cvdoubleitem{}{\strut\subsectionstyle{Tools}}{}{\strut\subsectionstyle{Frontend Frameworks}}
\cvdoubleitem{> 10 Jahre}{JIRA, Confluence, Maven, Jenkins}{> 6 Jahre\cbstart}{JSF}
