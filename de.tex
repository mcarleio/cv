...
\cvdoubleitem{> 13 Jahre}{Java, JS, HTML, Bash, SQL}{> 13 Jahre\cbstart}{Linux, Windows}
\cvdoubleitem{> 5 Jahre}{Kotlin, TypeScript}{> 3 Jahre}{AWS}
\cvdoubleitem{> 2 Jahre}{NodeJS}{> 2 Jahre\cbend}{Android}
\cvspace
...
\cvdoubleitem{> 5 Jahre}{Spring Boot, Java/Jakarta EE}{> 5 Jahre}{MySQL, MariaDB, H2}
\cvdoubleitem{> 3 Jahre}{Camunda}{> 3 Jahre}{PostgreSQL, Derby, MSSQL}
\cvdoubleitem{> 2 Jahre}{Quarkus}{> 1 Jahr\cbend}{NoSQL (Neo4j, MongoDB, Redis)}
\cvspace

\cvdoubleitem{}{\strut\subsectionstyle{Tools}}{}{\strut\subsectionstyle{Frontend Frameworks}}
\cvdoubleitem{> 13 Jahre}{JIRA, Confluence, Maven}{> 5 Jahre\cbstart}{Angular, JSF}
\cvdoubleitem{> 8 Jahre}{Git, GitLab, Docker}{> 3 Jahre}{Vaadin}
\cvdoubleitem{> 3 Jahre}{Gradle, Terraform}{\cbend}{}
...
\cvitem{\textbf{Konvert}}{Eine Kotlin Bibliothek (vergleichbar zu Mapstruct) zur Generierung von Mapping-Code zur compile-time.}
...
\cvitem{\textbf{Wahl-O-Mat Plugin}}{Ein Browser-Plugin, um beim Wahl-O-Mat für die Bundestagswahl 2021 neben den einzelnen Parteien auch eine grobe Übereinstimmung mit den möglichen Koalitionen einsehen zu können.}
\cvitem{\iconLink}{\link{https://mcarle.io/project/wahlomat-btw2021}}
\cvspace

\cvitem{\textbf{Mehr auf GitHub}}{
    Auf meinem GitHub-Konto veröffentliche ich weitere Projekte.
...
\cvitemize{Fantasy \& Sci-Fi}{Gerätetauchen}{}
